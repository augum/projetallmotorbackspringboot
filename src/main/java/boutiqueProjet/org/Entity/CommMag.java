...
public class CommMag {
    ...
    private List<LcommMag> lcomms = new ArrayList<>();

    public CommMag() {
    }

    public CommMag(long id, int annee, String numero, LocalDate date, long code_mag, String libelle, String lib_mag, double avance, double totht, double tottva, double totttc, String modepayement, String mag, List<LcommMag> lcomms) {
        this.id = id;
        this.annee = annee;
        this.numero = numero;
        this.date = date;
    ...
    public List<LcommMag> getLcomms() {
        return lcomms;
    }

    public void setLcomms(List<LcommMag> lcomms) {
        this.lcomms = lcomms;
    }
