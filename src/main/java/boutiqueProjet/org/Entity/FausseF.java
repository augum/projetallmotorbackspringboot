...
public class FausseF {
    ...
    private List<LfausseF> lcomms = new ArrayList<>();

    public FausseF() {
    }

    public FausseF(long id, int annee, int numero, LocalDate date, long code_mag, String libelle, String lib_mag, double avance, double totht, double tottva, double totttc, String modepayement, String mag, List<LfausseF> lcomms) {
        this.id = id;
        this.annee = annee;
        this.numero = numero;
        this.date = date;
    ...
    public List<LfausseF> getLcomms() {
        return lcomms;
    }

    public void setLcomms(List<LfausseF> lcomms) {
        this.lcomms = lcomms;
    }
