...
public class LcommMag {
    ...
    @JsonBackReference
    private CommMag comm;

    public LcommMag() {
    }

    public LcommMag(long id, String numero, String code_article, String libart, int pu, int qte, int tva, double totht, double tottva, double totttc, CommMag comm) {
        this.id = id;
        this.numero = numero;
    ...
    public CommMag getComm() {
        return comm;
    }

    public void setComm(CommMag comm) {
        this.comm = comm;
    }
