...
public class LfausseF {
    ...
    @JsonBackReference
    private FausseF comm;

    public LfausseF() {
    }

    public LfausseF(long id, int numero, String code_article, String libart, int pu, int qte, int tva, double totht, double tottva, double totttc, FausseF comm) {
        this.id = id;
        this.numero = numero;
    ...
    public FausseF getComm() {
        return comm;
    }

    public void setComm(FausseF comm) {
        this.comm = comm;
    }
