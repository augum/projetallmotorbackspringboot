...
public class Llivr {
    ...
    public Llivr(long id, String numero, String code_article, String libart, int pu, int qte, int tva, double totht, double tottva, double totttc, Livr comm) {
        super();
        this.id = id;
        this.numero = numero;
